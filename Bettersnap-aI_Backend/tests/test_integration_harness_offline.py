...
class MigrationScope(unittest.TestCase):
    ...
    def test_it_is_exactly_000_through_034(self):
        self.assertEqual(len(suite.CANONICAL_MIGRATIONS), 35)
        self.assertTrue(suite.CANONICAL_MIGRATIONS[0].startswith("000_"))
        self.assertTrue(suite.CANONICAL_MIGRATIONS[-1].startswith("034_"))
