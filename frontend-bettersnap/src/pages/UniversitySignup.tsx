...
const UniversitySignup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await instance.loginRedirect({ ...loginRequest, prompt: "create", loginHint: email });
    } catch (error: any) {
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="glass rounded-2xl shadow-glass p-8 w-full max-w-md space-y-6 relative">
          ...
          <div className="text-center space-y-2 pt-4">
            ...
            <h1 className="text-2xl font-heading font-bold text-foreground">University Student Sign Up</h1>
            <p className="text-muted-foreground text-sm">Sign up with your .edu email to get started</p>
          </div>
